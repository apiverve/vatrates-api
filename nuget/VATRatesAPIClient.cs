...
namespace APIVerve.API.VATRates
{
    ...
    /// <summary>
    /// Client for the VATRates API
    /// </summary>
    public class VATRatesAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/vatrates";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "postcode", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public VATRatesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public VATRatesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public VATRatesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, VATRatesQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(VATRatesQueryOptions options)
        {
        ...
        public ResponseObj Execute(VATRatesQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(VATRatesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(VATRatesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(VATRatesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(VATRatesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(VATRatesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(VATRatesQueryOptions options)
        {
