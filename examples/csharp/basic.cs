/*
 * VAT Rates API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the VAT Rates API.
 * API Documentation: https://docs.apiverve.com/ref/vatrates
 */
...
{
    class VATRatesExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/vatrates";

        /// <summary>
        /// Make a GET request to the VAT Rates API
        /// </summary>
        static async Task<JsonDocument> CallVATRatesAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling VAT Rates API...\n");

            var result = await CallVATRatesAPI();
