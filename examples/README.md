# VAT Rates API - Examples

This folder contains example code for using the VAT Rates API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/vatrates',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/vatrates");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/vatrates](https://docs.apiverve.com/ref/vatrates)
