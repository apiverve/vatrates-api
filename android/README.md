...
```gradle
dependencies {
    implementation 'com.github.apiverve:vatrates-api:1.1.13'
}
```
...
```java
import com.apiverve.vatrates.VATRatesAPIClient;
import com.apiverve.vatrates.APIResponse;
import com.apiverve.vatrates.APIException;

// Initialize the client
VATRatesAPIClient client = new VATRatesAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("country", "DE");
    parameters.put("date", "2020-07-01");
    parameters.put("postcode", "35001");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/vatrates](https://docs.apiverve.com/ref/vatrates)
...
- **Documentation:** [https://docs.apiverve.com/ref/vatrates](https://docs.apiverve.com/ref/vatrates)
- **Issues:** [GitHub Issues](https://github.com/apiverve/vatrates-api/issues)
