...
class vatratesWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/vatrates');
        }
        ...
        this.validationRules = {"country":{"type":"string","required":true,"minLength":2,"maxLength":2},"date":{"type":"string","required":false,"format":"date"},"postcode":{"type":"string","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/vatrates`);
        }
    }
...
module.exports = vatratesWrapper;
